...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'aarch64-conda_cos7-linux-gnu-gcc -pthread -shared -Wl,-O2 '
              ...
              '-Wl,-rpath,/home/jovyan/ISSItutorial/conda/lib '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro '
                      ...
                      '-Wl,-rpath,/home/jovyan/ISSItutorial/conda/lib '
                      '-L/home/jovyan/ISSItutorial/conda/lib',
 'CONFIG_ARGS': "'--prefix=/home/jovyan/ISSItutorial/conda' "
                ...
                "-I/home/jovyan/ISSItutorial/conda/include' "
                "'CPP=/home/jovyan/ISSItutorial/conda/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBFFI_INCLUDEDIR': '/home/jovyan/ISSItutorial/conda/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/jovyan/ISSItutorial/conda/lib/pkgconfig',
 'LIBPL':
     '/home/jovyan/ISSItutorial/conda/lib/python3.7/config-3.7m-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/home/jovyan/ISSItutorial/conda/include',
 'OPENSSL_LDFLAGS': '-L/home/jovyan/ISSItutorial/conda/lib',
